(function(root, factory) {
    ...
    'use strict'
    var defaultOptions = { tick: 1, onstart: null, ontick: null, onpause: null, onstop: null, onend: null }
    ...
    Timer.prototype.start = function(duration) {
        ...
        if (typeof this._.options.ontick === 'function')
            this._.interval = setInterval(function() { trigger.call(this, 'ontick', this.getDuration()) }.bind(this), +this._.options.tick * 1000)
    ...
    Timer.prototype.getStatus = function() { return this._.status }
    ...
    Timer.prototype.measureStop = function(label) { return +new Date - this._.measures[label || ''] }
